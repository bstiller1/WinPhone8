...
namespace Core.Viewmodels
{
    ...
    public class NavigatorAwareBaseViewmodel : BaseViewmodel
    {
        ...
        public NavigatorAwareBaseViewmodel()
        {
        ...
        private void GoBack()
        {
            ...
            {
                INavigatorService navigatorService = ServiceLocator.RetrieveOnce<INavigatorService>();
        ...
        public void UpdateCanGoBack()
        {
            if (ServiceLocator != null)
            {
                ...
                if (navigatorService != null)
                {
                    CanGoBack = navigatorService.CanGoBack();
                }
            }
        }
    }
