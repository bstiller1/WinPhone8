...
namespace TestLifecycle
{
    public partial class App : Application
    {
        ...
        private void RootFrame_Navagating(object sender, NavigatingCancelEventArgs e)
        {
            if (e.NavigationMode == NavigationMode.Reset)
            {
                isResume = true;
            }
            else if (e.NavigationMode == NavigationMode.New && isResume)
        ...
        {
            Debug.WriteLine("Applicaion Launching");
        }
